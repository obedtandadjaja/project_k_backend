...
type Payment struct {
	...
	RoomOccupancyID uuid.UUID      `json:"room_occupancy_id" db:"room_occupancy_id"`
	RoomOccupancy   *RoomOccupancy `json:"room_occupancy,omitempty" belongs_to:"room_occupancy"`
